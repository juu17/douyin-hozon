...
# Pinned upstream commit. Bump intentionally after verifying the parser
# sidecar still imports cleanly (see plan: i-want-to-tame-snazzy-snowglobe).
...
# Set up the parser sidecar's Python virtualenv.
...
echo "douyin-hozon prerequisites ready (downloader at ${TARGET_DIR}, venv at ${VENV_DIR})"
